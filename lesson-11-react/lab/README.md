...
4. Create onClick handler that will be called when button is clicked.
...
1. Run the react app and open your browser at http://localhost:3000
    ...
    You should see the chart with the ETHUSD price from the JSON file.
